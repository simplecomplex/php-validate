...
use SimpleComplex\Validate\RuleTraits\EnumEquatableCheckedTrait;
 ...
 * @see EnumEquatableUncheckedValidator
 *
 * @package SimpleComplex\Validate
 */
class EnumEquatableValidator extends Validator
{
    use EnumEquatableCheckedTrait;
