...
class ValidateUnchecked implements RuleProviderInterface
{
    ...
    const TYPE_METHODS = [
        ...
        'float' => null,
        'string' => null,
        'stringableScalar' => null,
        'stringableObject' => null,
        'stringable' => null,
        'resource' => null,
        'numeric' => null,
        'digital' => null,
     ...
     *
     * Is type-checking. Must be, because also used for alternativeEnum.
     ...
     * @return bool
     */
    public function scalarNullable($subject) : bool
    {
...
//        return false;
    ...
    /**
     * Positive number/numeric; not zero and not negative.
     *
     * @see Type::NUMERIC
     * @see Validate::number()
     * @see Validate::integer()
    ...
    /**
     * Zero or positive number/numeric.
     *
     * @see Type::NUMERIC
     * @see Validate::number()
     * @see Validate::integer()
    ...
    /**
     * Negative number/numeric; not zero and not positive.
     *
     * @see Type::NUMERIC
     * @see Validate::number()
     * @see Validate::integer()
